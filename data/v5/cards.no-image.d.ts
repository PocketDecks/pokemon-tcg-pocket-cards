...
export type PokemonTCGPocketCardsV5NoImageSchema = {
  ...
  pack: string;
  /**
   * ISO 8601 formatted release date. Null for promos.
   */
  ...
  rarity: string | null;
  /**
   * The cost to craft the card. Null for promos.
   */
  ...
  mega: boolean;
  /**
   * True if the card depicts a shiny variant.
   */
  shiny: boolean;
  /**
  ...
  /**
   * The visual treatment category (e.g., "Full Art", "Special Illustration Art", etc.)
   */
